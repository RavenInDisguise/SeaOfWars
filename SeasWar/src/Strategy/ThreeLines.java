...
public class ThreeLines implements IAtacar{
    ...
    public void atacarCasillas(Jugador jugadorActual, String[] arrayComandos) {
        int x1=Integer.parseInt(arrayComandos[4]);
        int y1=Integer.parseInt(arrayComandos[5]);
        generarRadio(jugadorActual, x1, y1);
        
        int x2=Integer.parseInt(arrayComandos[6]);
        int y2=Integer.parseInt(arrayComandos[7]);
        generarRadio(jugadorActual, x2, y2);
        
        int x3=Integer.parseInt(arrayComandos[8]);
        int y3=Integer.parseInt(arrayComandos[9]);
